...
ADA_LOCKED_ACCOUNT=452afe41ec60ed8162de702e84d92dd199dc406b
ADA_LOCKED_PASSPHRASE=test-wallet
...
${FORCE_BRIDGE_CLI} btc balanceOf -addr ${CKB_RECIPIENT_ADDRESS}
sleep 60
${FORCE_BRIDGE_CLI} ada balanceOf -id ${ADA_LOCKED_ACCOUNT}
${FORCE_BRIDGE_CLI} eth lock -id ${ADA_LOCKED_ACCOUNT} -p ${ADA_LOCKED_PASSPHRASE} -r ${CKB_RECIPIENT_ADDRESS} -a 500